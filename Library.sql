...
userid nvarchar2(50) constraint pk_Library_member not null primary key,
...
insert into LIBRARY_MEMBER(name,userid,password,email,address,phone_number,grade number,joindate,lease_status,brithYear)
