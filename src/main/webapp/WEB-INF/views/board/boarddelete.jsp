...
<table class="table table-striped">
	<thead>${vo.bno}번 글 삭제하기</thead>
	<tbody>
<form role="form" action="/board/delete" method="post">
			
                <input type="hidden" value="${vo.title}" name="title" class="form-control" required/>
                <input type="hidden" value="${vo.bno}" name="bno"/>
                <input type="hidden" value="${vo.writer}" name="writer" class="form-control" readonly="readonly"/>
