...
create table bookList(
	...
	userid nvarchar2(20) ,
	constraint fk_book_list foreign key(userid)
references Library_member(userid)
on delete cascade
...
update library_member SET lease_status  =(select status from booklist where booklist.userid=library_member.userid);
